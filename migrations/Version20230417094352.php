 ...
 */
final class Version20230417094352 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE program ADD year INT DEFAULT NULL, CHANGE category_id category_id INT DEFAULT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE program DROP year, CHANGE category_id category_id INT NOT NULL');
    }
}
